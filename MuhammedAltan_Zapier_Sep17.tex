...
\section{Leadership}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Directed 3-member team launching a responsive website, achieving \textbf{30\%} enhancement in mobile usability and client satisfaction.}
        \resumeItem{Optimized design via iterative feedback loops, boosting user engagement by \textbf{60\%}.}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
