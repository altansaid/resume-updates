...
\section{Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Delivered comprehensive platform using \textbf{React} and \textbf{Node.js}, with \textbf{Gemini AI APIs} for dynamic question generation, offering tailored interview preparation solutions.}
        \resumeItem{Implemented \textbf{robust authentication}, featuring advanced role-based access control and reinforced data security protocols.}
        \resumeItem{Equipped application for deployment with strategic \textbf{unit testing}, \textbf{CI/CD} pipeline integration, and containerized deployment solutions.}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
